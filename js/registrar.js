...
function iniciar(){
    ...
    if(btnenviar.addEventListener){
        btnenviar.addEventListener("click", function(){
            ...
            var chkvalue, selvalue, nuevoUsuario, bandera;
            bandera = false;
            ...
            //selvalue = document.frmRegistro.seldegree.options[frmRegistro.seldegree.selectedIndex].value;
   			...
   			var valoresAceptados2 = /^[0-9a-zA-Z]+$/;

   			//validación del DUI
	       	if (document.frmRegistro.dui.value.match(valoresAceptados)){
          		bandera = false:
       		} else {
         		bandera = true;
      		...
      		//validación NIT
      		if (document.frmRegistro.nit.value.match(valoresAceptados)){
          		bandera = false:
       		} else {
         		bandera = true;
      		...
      		if (document.frmRegistro.nit.value.length == 14) {
      			...
      			bandera = true;
      			alert("El DUI debe contener sólo 14 dígitos", "Error");
      		}

      		//Validación placa
      		if (document.frmRegistro.placa.value.match(valoresAceptados2) && document.frmRegistro.dui.value.length == 6){
          		bandera = false:
       		} else {
         		bandera = true;
